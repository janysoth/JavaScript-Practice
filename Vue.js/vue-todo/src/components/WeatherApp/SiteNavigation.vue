<template>
  <header class="sticky top-0 bg-cambodia-red shadow-lg">
    ...
    >
      ...
      <RouterLink
        :to="{ name: 'WeatherApp' }"
        class="hover:text-cambodia-blue duration-150 cursor-pointer"
      >
      ...
      <div class="flex gap-3 flex-1 justify-end">
        <i
          class="fa-solid fa-circle-info text-xl hover:text-cambodia-blue duration-150 cursor-pointer"
          @click="toggleModal"
        ></i>
        <i
          class="fa-solid fa-plus text-xl hover:text-cambodia-blue duration-150 cursor-pointer"
        ></i>
      </div>
      <!---->
